"""Deprecated RFC lineage A implementation.

Kept temporarily as an unwired comparison/reference module after lineage_b was
promoted to ai_org.rfc.lineage. Do not import from pull wiring or new code.
