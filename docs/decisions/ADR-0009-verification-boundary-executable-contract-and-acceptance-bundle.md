...
grows; each new tool inherits this addendum's rule unchanged. **This roadmap is a build list, not a wish-list —
close the gap by implementing it, not by trimming it.**
